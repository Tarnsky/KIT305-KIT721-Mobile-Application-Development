...
class GamePlay2 extends StatefulWidget {
  GamePlay2({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _GamePlay2 createState() => _GamePlay2();
}

class _GamePlay2 extends State<GamePlay2> {
  int? scoreLimit = _GamePlay2.repLimit;
  int score = 0;
  int totalClicks = 0;
