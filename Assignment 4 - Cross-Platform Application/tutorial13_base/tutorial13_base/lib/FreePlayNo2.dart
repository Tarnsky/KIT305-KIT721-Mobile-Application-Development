...
class FreePlayNo2 extends StatefulWidget {
  FreePlayNo2({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _FreePlayNo2 createState() => _FreePlayNo2();
}

class _FreePlayNo2 extends State<FreePlayNo2> {
  int? scoreLimit = _FreePlayNo2.repLimit;
  int score = 0;
  int totalClicks = 0;
