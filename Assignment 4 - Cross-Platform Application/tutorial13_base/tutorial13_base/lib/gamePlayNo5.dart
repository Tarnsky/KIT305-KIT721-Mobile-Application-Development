...
class GamePlayNo5 extends StatefulWidget {
  GamePlayNo5({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _GamePlayNo5 createState() => _GamePlayNo5();
}

class _GamePlayNo5 extends State<GamePlayNo5> {
  int? scoreLimit = _GamePlayNo5.repLimit;
  int score = 0;
  int totalClicks = 0;
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              SizedBox(height: 30),
              Text('TapTapReHab'),
              Text('Score to win: ' + widget.repLimit.toString()),
              Text('Press The button in Order to score'),
              Text(buttonTrackerText + tracker.toString()),
              Text('Score: ' + '$score' + '/' + widget.repLimit.toString()),
              SizedBox(height: 30),
              Container(
                height: sizeHight,
                width: sizeWidth,
