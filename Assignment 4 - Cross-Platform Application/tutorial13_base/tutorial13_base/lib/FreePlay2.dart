...
class FreePlay2 extends StatefulWidget {
  FreePlay2({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _FreePlay2 createState() => _FreePlay2();
}

class _FreePlay2 extends State<FreePlay2> {
  int? scoreLimit = _FreePlay2.repLimit;
  int score = 0;
  int totalClicks = 0;
