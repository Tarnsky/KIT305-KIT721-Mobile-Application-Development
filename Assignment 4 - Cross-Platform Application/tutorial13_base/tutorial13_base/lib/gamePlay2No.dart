...
class GamePlayNo2 extends StatefulWidget {
  GamePlayNo2({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _GamePlayNo2 createState() => _GamePlayNo2();
}

class _GamePlayNo2 extends State<GamePlayNo2> {
  int? scoreLimit = _GamePlayNo2.repLimit;
  int score = 0;
  int totalClicks = 0;
