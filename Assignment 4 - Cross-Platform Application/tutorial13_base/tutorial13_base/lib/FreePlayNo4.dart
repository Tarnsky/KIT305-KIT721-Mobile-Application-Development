...
class FreePlayNo4 extends StatefulWidget {
  FreePlayNo4({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _FreePlayNo4 createState() => _FreePlayNo4();
}

class _FreePlayNo4 extends State<FreePlayNo4> {
  int? scoreLimit = _FreePlayNo4.repLimit;
  int score = 0;
  int totalClicks = 0;
