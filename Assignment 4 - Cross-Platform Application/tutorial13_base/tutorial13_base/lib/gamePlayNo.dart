...
class GamePlayNo extends StatefulWidget {
  GamePlayNo({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _GamePlayNo createState() => _GamePlayNo();
}

class _GamePlayNo extends State<GamePlayNo> {
  int? scoreLimit = _GamePlayNo.repLimit;
  int score = 0;
  int totalClicks = 0;
