...
class FreePlayNo extends StatefulWidget {
  FreePlayNo({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _FreePlayNo createState() => _FreePlayNo();
}

class _FreePlayNo extends State<FreePlayNo> {
  int? scoreLimit = _FreePlayNo.repLimit;
  int score = 0;
  int totalClicks = 0;
