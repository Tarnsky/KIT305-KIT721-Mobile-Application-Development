...
class GamePlay4 extends StatefulWidget {
  GamePlay4({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _GamePlay4 createState() => _GamePlay4();
}

class _GamePlay4 extends State<GamePlay4> {
  int? scoreLimit = _GamePlay4.repLimit;
  int score = 0;
  int totalClicks = 0;
