...
class FreePlay5 extends StatefulWidget {
  FreePlay5({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _FreePlay5 createState() => _FreePlay5();
}

class _FreePlay5 extends State<FreePlay5> {
  int? scoreLimit = _FreePlay5.repLimit;
  int score = 0;
  int totalClicks = 0;
