...
class GamePlayNo4 extends StatefulWidget {
  GamePlayNo4({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _GamePlayNo4 createState() => _GamePlayNo4();
}

class _GamePlayNo4 extends State<GamePlayNo4> {
  int? scoreLimit = _GamePlayNo4.repLimit;
  int score = 0;
  int totalClicks = 0;
