...
class FreePlayNo5 extends StatefulWidget {
  FreePlayNo5({Key? key, required this.title, required this.repLimit})
      : super(key: key);
  ...
  @override
  _FreePlayNo5 createState() => _FreePlayNo5();
}

class _FreePlayNo5 extends State<FreePlayNo5> {
  int? scoreLimit = _FreePlayNo5.repLimit;
  int score = 0;
  int totalClicks = 0;
